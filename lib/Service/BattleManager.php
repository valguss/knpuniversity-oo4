...
class BattleManager
{
     ...
     * @return BattleResult
     */
    public function battle(\Model\AbstractShip $ship1, $ship1Quantity, \Model\AbstractShip $ship2, $ship2Quantity)
    {
        ...
        return new \Model\BattleResult($usedJediPowers, $winningShip, $losingShip);
    }
	 ...
	 * @return bool
	 */
    private function didJediDestroyShipUsingTheForce(\Model\AbstractShip $ship)
    {
